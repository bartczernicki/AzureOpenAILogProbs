        ...
        {
            {
                ...
                while (true)
                {
                    ...
                    Console.WriteLine("Select one of the options to run, by typing either 1 through 5:");
                    ...
                    Console.WriteLine("5) Exit the AI LogProbs evaluation."); 
                    ...
                    if (validInput)
                    {
                        ...
                        Qualitatively Average Brier Scores of: 
                        0.0 - 0.10 are excellent, 
                        0.1 - 0.20 are superior, 
                        0.2 - 0.30 are adequate, 
                        0.3 - 0.35 are acceptable, 
                        greater than 0.35 indicate poor prediction performance.
                        """);
                            }
                        }
